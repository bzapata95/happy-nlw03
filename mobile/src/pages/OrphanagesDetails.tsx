  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <Text style={styles.title}>Instrucciones para visita</Text>
        ...
        <View style={styles.scheduleContainer}>
          ...
          {orphanage.open_on_weekends ? (
            <View style={[styles.scheduleItem, styles.scheduleItemGreen]}>
             ...
             <Text style={[styles.scheduleText, styles.scheduleTextGreen]}>Atención para fin de semana</Text>
           </View>
          ) : (
            <View style={[styles.scheduleItem, styles.scheduleItemRed]}>
              <Feather name='info' size={40} color='#FF669D' />
              <Text style={[styles.scheduleText, styles.scheduleTextRed]}>No atendemos para fin de semana</Text>
            </View>
          )} 
        </View>
